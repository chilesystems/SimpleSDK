...
{
    public class EncabezadoExportacion
    {
        /// <summary>
        ...
        /// </summary>
        [XmlElement("Totales")]
        public TotalesExportacion Totales { get; set; }
        ...
        public bool ShouldSerializeOtraMoneda() { return OtraMoneda.TipoMoneda != CodigosAduana.Moneda.NotSet; }

        public EncabezadoExportacion()
        {
            ...
            Transporte = null;
            Totales = new TotalesExportacion();
